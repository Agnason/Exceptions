    ...
    * */
    public static void ex3() {
        try {
            ...
            System.out.println("Íà íîëü äåëèòü íåëüçÿ");
        } catch (NullPointerException ex) {
            System.out.println("Óêàçàòåëü íå ìîæåò óêàçûâàòü íà null!");
        } catch (IndexOutOfBoundsException ex) {
            System.out.println("Ìàññèâ âûõîäèò çà ïðåäåëû ñâîåãî ðàçìåðà!");
        } catch (Throwable ex) {
            System.out.println("×òî-òî ïîøëî íå òàê...");
        }finally {
            System.out.println("Äà áóäåò ñâåò!");
        }
    }
...
public static void scan2() {
    Scanner scanner= new Scanner(System.in);
        System.out.println("Íàïèøèòå ÷òî-íèáóäü!!!");
        String enter = scanner.nextLine();
        if (enter.isBlank()) {
            throw new RuntimeException("Ïóñòûå ñòðîêè ââîäèòü íåëüçÿ");
        }
}
